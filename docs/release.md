...
```bash
python -m tarfile -l dist/local_context_compiler-0.2.0.tar.gz
python -m zipfile -l dist/local_context_compiler-0.2.0-py3-none-any.whl
```
...
/tmp/lcc-wheel-smoke/bin/python -m pip install dist/local_context_compiler-0.2.0-py3-none-any.whl
```
