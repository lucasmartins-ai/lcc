"""Local quality gates and verification for local-first agent execution."""
...
class RuleBasedVerifier:
    """Conservative structured gate. High uncertainty or invalid format escalates to remote."""
