"""Adapter over existing LCC capabilities (inspection, lexical selection, optimization)."""
...
from lcc.router.schemas import LCCReportSummary, PreparedContext, TaskInput
...
def inspect_context(task: TaskInput) -> LCCReportSummary:
    """Run deterministic LCC inspection and return the router summary."""
    try:
