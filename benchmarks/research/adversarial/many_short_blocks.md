...
Check review note: the failing checks and the full check list were reviewed across the whole run. The note records that the checks were examined and that some were failing, without listing a single check name or its result.
