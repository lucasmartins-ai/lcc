...
Deployment review note: the manifest, the replicas, the region and the resource limits were discussed. The note records that the deployment manifest was reviewed and quotes no configuration from it.

{"service": "booking-api", "replicas": 6, "region": "eu-west-2", "resource_limits": {"cpu": "500m", "memory": "1Gi"}, "notes": "steady state"}
