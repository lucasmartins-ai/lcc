...
Integration review note: the integration, the endpoint, the retries and the backoff strategy were discussed. The note records that the integration configuration was reviewed and specifies no setting.

<integration><endpoint>https://api.example.com/v2</endpoint><retries>3</retries><backoff>exponential</backoff></integration>
