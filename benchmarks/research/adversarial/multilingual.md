...
Brazilian clinic note: the clinic, the appointments, the confirmations and the after-hours window were discussed. The note is written in English and states no percentage and no finding from the clinic.
...
Relato da clinica: cerca de 41 por cento dos agendamentos sao perdidos porque o paciente nao recebe confirmacao fora do horario de atendimento.
