...
Funnel review note: conversion, the measured period and the funnel were discussed together. The note confirms the conversation covered conversion across the funnel and states no rate, no change and no exclusion.

Conversion rate rose from 3.1 percent to 4.8 percent over the measured period across the whole funnel.
...
Important exception: the conversion figure excludes returning customers entirely, so it describes first-time visitors only.
