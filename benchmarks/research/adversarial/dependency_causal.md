...
Retrospective agenda: conversion, the checkout flow and the June release were all on the agenda. This item records that the relationship between the refactor and conversion was going to be discussed, without capturing any movement or any cause.
...
The checkout flow was refactored in June, replacing the multi-step form with a single page.
...
Conversion dropped by 12 percent in June, immediately after the checkout flow refactor shipped to production.
