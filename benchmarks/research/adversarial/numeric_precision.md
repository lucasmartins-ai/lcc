...
Performance review note: response time, the booking endpoint and the load profile were covered. The note says the measured response time was reviewed against the standard profile and records no number.

Measured p95 response time for the booking endpoint is 4.20 seconds under the standard production load profile.
...
An unrelated internal dashboard reports a 42 second batch window for the nightly reconciliation job that runs outside business hours.
