...
Naming note: the practice name, the trading name and the registered entity were reviewed. The note confirms the practice name was checked and writes no spelling and no registration reference.
...
The practice trades as OdontoVero — Clínica Odontológica, registered as オドントベーロ for the JP entity, contact +55 62 98181-8185.
