...
Configuration review note: the request timeout, the gateway and the upstream settings were discussed. It confirms the timeout and the configuration were reviewed and states no value in any unit.

The gateway configuration sets the upstream request timeout to 10000 ms in the deployment manifest used by production.
