...
LOG 1: queue worker heartbeat ok in 554ms, backlog 287 jobs, retry budget untouched, no dead letters in the last window.

LOG 2: cron job lead-sync finished with 366 records processed and 3377 ms elapsed; nothing to report beyond the routine summary line.
...
LOG 4: queue worker heartbeat ok in 7479ms, backlog 301 jobs, retry budget untouched, no dead letters in the last window.

LOG 5: cron job lead-sync finished with 3 records processed and 4677 ms elapsed; nothing to report beyond the routine summary line.
